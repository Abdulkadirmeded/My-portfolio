    ...
    <div className='mt-24 max-w-[1200px] mx-auto relative'>
      <div className=' grid md:grid-cols-2 place-items-center gap-8'>
        ...
        >
          ...
          >
            HEY, I AM <br />
            <span className='text-purple-500'>ABDULKADIR</span>
          </motion.p>
          ...
          >
            ...
            <div className='flex gap-6 flex-row text-4xl md:text-6xl text-purple-400 z-20'>
              <motion.a whileHover={{scale: 1.2}} href='https://github.com/Abdulkadirmeded'>
                <GitHubIcon/>
              ...
              <motion.a whileHover={{scale: 1.2}} href='https://www.linkedin.com/in/abdulkadirmeded/'>
                <LinkedInIcon/>
      ...
      <motion.div
        ...
        transition={{duration: 1, delay: 2}}
         className=" flex flex-row text-7xl px-12 md:px-0 w-full 
